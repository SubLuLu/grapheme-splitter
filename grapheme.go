...
// taken from https://www.unicode.org/Public/12.0.0/ucd/auxiliary/GraphemeBreakProperty-12.0.0d16.txt
const (
	CR = iota
	LF
	Control
...
func graphemeBreakProperty(code rune) int {
	// Prepend
	...
	if (0x0000 <= code && code <= 0x0009) || // Cc  [10] <control-0000>..<control-0009>
		...
		(0x200E == code || 0x200F == code) || // Cf   [2] LEFT-TO-RIGHT MARK..RIGHT-TO-LEFT MARK
	...
	if (0x0300 <= code && code <= 0x036F) || // Mn [112] COMBINING GRAVE ACCENT..COMBINING LATIN SMALL LETTER X
		...
		(0x08D3 <= code && code <= 0x08E1) || // Mn  [14] ARABIC SMALL HIGH WORD AR-RUB..ARABIC SMALL HIGH SIGN SAFHA
		...
		(0x0EB4 <= code && code <= 0x0EBC) || // Mn   [6] LAO VOWEL SIGN I..LAO VOWEL SIGN LO
		...
		(0x111C9 <= code && code <= 0x111CC) || // Mn   [3] SHARADA SIGN NUKTA..SHARADA EXTRA SHORT VOWEL MARK
		...
		0x119D2 == code || // Mn       NANDINAGARI VOWEL SIGN I
	...
	if 0x0903 == code || // Mc       DEVANAGARI SIGN VISARGA
		...
		0x119D1 == code || // Mc       NANDINAGARI VOWEL SIGN AA
		0x119D3 == code || // Mc       NANDINAGARI VOWEL SIGN II
		(0x119DC == code && code <= 0x119DC) || // Mc   [4] NANDINAGARI VOWEL SIGN O..NANDINAGARI SIGN VISARGA
